...
const Navbar = () => {
    ...
    return (
        <header className="navbar-glass-glow fixed w-full top-0 z-40 border-b border-gray-800 animate-navbar-fade-in" style={{marginBottom: '10px'}}>
                ...
                <div className="flex items-center justify-between h-full relative z-10">
                    ...
                    <div className="flex-shrink-0">
                        <Link to='/' className="flex items-center gap-2.5 hover:opacity-80 transition-all">
                            ...
                            <h1 className="text-lg font-semibold navbar-gradient-text">SecureNest</h1>
                        </Link>
                    </div>
