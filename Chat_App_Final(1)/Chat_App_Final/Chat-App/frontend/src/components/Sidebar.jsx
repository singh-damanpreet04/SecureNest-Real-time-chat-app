            ...
            <aside className="h-full flex flex-col relative z-10">
                ...
                <div className="px-4 pt-6 pb-2 bg-transparent">
                    <div className="relative group">
                        <input
                            type="text"
                            className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#0f172a]/80 text-gray-200 placeholder-gray-400 focus:outline-none border border-white/10 shadow-md transition-all backdrop-blur-md sidebar-search-visual"
                ...
                <div className="overflow-y-auto w-full max-w-full py-3" style={{boxSizing:'border-box'}}>
                    {users && users.length > 0 ?
                        ...
                        <button
                         ...
                         className={`w-full max-w-full flex items-center gap-3 p-3 transition-all duration-200 rounded-xl backdrop-blur-[2px] border border-white/5 shadow-md box-border overflow-hidden
                            ${selectedUser?._id === user._id 
                                ? "bg-gradient-to-r from-blue-700/50 to-indigo-700/40 border-l-4 border-blue-400 shadow-blue-500/20 animate-float" 
                                : "hover:bg-gradient-to-r hover:from-blue-600/30 hover:to-indigo-600/20 hover:shadow-blue-400/10"
                         }`}
                        >
